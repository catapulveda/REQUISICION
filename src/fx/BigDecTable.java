...
public class BigDecTable extends Application {
    ...
    public void start(Stage primaryStage) {
        ObservableList<Data> data = FXCollections.observableArrayList(
                new Data(new BigDecimal(123.4546527, mc), new BigDecimal(123.4575755, mc)),
    ...
    public class Data {
        ...
        public SimpleObjectProperty<BigDecimal> fld1Property() {
            return fld1;
        }

        public SimpleObjectProperty<BigDecimal> fld2Property() {
            return fld2;
        }

        public SimpleObjectProperty<BigDecimal> fld3Property() {
            return fld3;
        }
